...
export const navbarStyles = {
  ...
  logoImage: "w-15 h-15 rounded-full overflow-hidden",
  
  // Text styles
  logoText: "lg:text-2xl md:text-3xl text-2xl text-gray-900 font-[550] lobster-regular pl-2",
...
export const sidebarStyles = {
  ...
  footerLink: {
    base: "flex items-center gap-0.5 py-2 rounded-xl font-medium text-gray-600 hover:text-teal-700 hover:bg-gray-50",
  ...
  mobileFooterLink: "flex items-center gap-1 py-2 font-medium text-gray-600 hover:text-teal-700",
